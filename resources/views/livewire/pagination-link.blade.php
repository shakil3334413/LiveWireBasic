...
<ul class="flex justify-between" style="list-style: none;">
    <!-- prev -->
    @if ($paginator->onFirstPage())
    <li  style="cursor: pointer;" class="w-16 px-2 py-1 text-center rounded border bg-gray-200">Prev</li>
    @else
    <li style="cursor: pointer;" class="w-16 px-2 py-1 text-center rounded border shadow bg-white cursor-pointer" wire:click="previousPage">Prev</li>
    @endif
    <!-- prev end -->
